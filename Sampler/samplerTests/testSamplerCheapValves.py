...
logfilename = '/home/pi/SamplerDev/logs/samplingTest_CheapValves_40MinPerTube.dat'
...
try:
    ...
    for tube in range(1,17):
        savetube = tube
        for i in range(0,secsBetweenTubes):
            tube = 0
            writelog()
            tube = savetube
            time.sleep(1)
        s.setTube(tube,True,pauseBetween=delayBetweenValves)
